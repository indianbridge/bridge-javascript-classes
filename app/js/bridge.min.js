'use strict';if("undefined"===typeof jQuery)throw Error("jQuery is not loaded. jQuery is required for Bridge Javascript Library to work.");if("undefined"===typeof _)throw Error("Lodash is not loaded. Lodash is required for Bridge Javascript Library to work.");
...
d=a[c+1].split(",");this.setDealer({1:"s",2:"w",3:"n",4:"e"}[d[0][0]]);l=d[0].slice(1);f="s";this.getHand(f).setHand(l);for(e=1;e<d.length;++e)f=Bridge.getLHO(f),l=d[e],this.getHand(f).setHand(l);this.assignRest();break;case "mb":Bridge._checkIndex(a,c+1,"In Bridge.Deal.fromLin - processing mb - ");e=a[c+1].split("!")[0].slice(0,2).toLowerCase();"d"===e&&(e="x");f=null;c+2<a.length&&"an"===a[c+2].toLowerCase()&&(f=a[c+3],f=f.replace("(",""),f=f.replace(")",""));this.getAuction().addCall(e,null,f);
break;case "pc":Bridge._checkIndex(a,c+1,"In Bridge.Deal.fromLin - processing pc - ");e=a[c+1].slice(0,2);this.getPlay().addPlayedCard(e[0],e[1]);break;case "sv":Bridge._checkIndex(a,c+1,"In Bridge.Deal.fromLin - processing sv - "),e=a[c+1],"o"===e&&(e="-"),this.setVulnerability(e)}};
Bridge.Deal.prototype.onChange=function(a,b){if(this.triggerEvents){Bridge.options.enableDebug&&console.log("deal:changed "+a+" - "+b);$(document).trigger("deal:changed",[this,a,b]);var c=this.getID();c&&$(document).trigger(c+":deal:changed",[this,a,b])}};Bridge||(Bridge={});Bridge.Card=function(a,b){Bridge._checkSuit(a);this.suit=a;Bridge._checkRank(b);this.rank=b;this.direction=null;this.played=!1};Bridge.Card.prototype.getSuit=function(){return this.suit};Bridge.Card.prototype.getRank=function(){return this.rank};Bridge.Card.prototype.getDirection=function(){return this.direction};Bridge.Card.prototype.setDirection=function(a){Bridge._checkDirection(a);this.direction=a};Bridge.Card.prototype.assign=function(a){this.setDirection(a)};
...
Bridge.Call.prototype.toString=function(){var a;a=""+this.call;this.explanation&&(a+="("+this.explanation+")");this.annotation&&(a+="{"+this.annotation+"}");return a};Bridge||(Bridge={});Bridge.Auction=function(a){this.id=(this.deal=a)?a.id:null;this.dealer=a?a.getDealer():"n";this.vulnerability=a?a.getVulnerability():"-";this.nextToCall=this.dealer;this.calls=[];this.contracts=[];this.selectedLevel=0;this.currentAuctionIndex=-1;this.triggerEvents=!0};Bridge.Auction.prototype.enableEventTrigger=function(){this.triggerEvents=!0};Bridge.Auction.prototype.disableEventTrigger=function(){this.triggerEvents=!1};Bridge.Auction.prototype.getNextToCall=function(){return this.nextToCall};
...
Bridge.Auction.prototype.advanceAuctionTillIndex_=function(a){(0>a||a>=this.calls.length)&&Bridge._reportError("Cannot advance because specified call number "+a+" is invalid","In Bridge.Auction.advanceAuctionTillIndex_");for(this.currentAuctionIndex>=a&&Bridge._reportError("Cannot advance because current call number is at or greater than specified call number "+a,"In Bridge.Auction.advanceAuctionTillIndex_");this.currentAuctionIndex<a;){this.currentAuctionIndex++;var b=this.calls[this.currentAuctionIndex];
this.onChange("advanceAuction",b)}this.onChange("advanceAuction:completed",b)};Bridge.Auction.prototype.advanceAuction=function(){this.advanceAuctionTillIndex_(this.currentAuctionIndex+1)};Bridge.Auction.prototype.advanceAuctionAll=function(){this.advanceAuctionTillIndex_(this.calls.length-1)};
Bridge.Auction.prototype.rewindAuctionTillIndex_=function(a){(-1>a||a>=this.calls.length-1)&&Bridge._reportError("Cannot rewind because specified call number "+a+" is invalid","In Bridge.Auction.rewindAuctionTillIndex_");for(this.currentAuctionIndex<=a&&Bridge._reportError("Cannot rewind because current call number is at or lesser than specified call number "+a,"In Bridge.Auction.rewindAuctionTillIndex_");this.currentAuctionIndex>a;){var b=this.calls[this.currentAuctionIndex];this.currentAuctionIndex--;
this.onChange("rewindAuction",b)}this.onChange("rewindAuction:completed",b)};Bridge.Auction.prototype.rewindAuction=function(){this.rewindAuctionTillIndex_(this.currentAuctionIndex-1)};Bridge.Auction.prototype.rewindAuctionAll=function(){this.rewindAuctionTillIndex_(-1)};Bridge.Auction.prototype.rewind=Bridge.Auction.prototype.rewindAuctionAll;
Bridge.Auction.prototype.fromString=function(a){this.clearCalls();for(var b=0;b<a.length;){var c=a[b++].toLowerCase();"d"===c&&(c="x");for(var c=_.has(Bridge.calls,c)&&!Bridge.isStrain(c)?c:c+a[b++].toLowerCase(),d=null,e=null;b<a.length&&("("===a[b]||"{"===a[b]);){if("("===a[b])var f=")",b=Bridge._parseContainedText(a,b,f,"In Auction.fromString"),d=b.text;else f="}",b=Bridge._parseContainedText(a,b,f,"In Auction.fromString"),e=b.text;b=b.position+1}this.addCall(c,d,e)}};
...
d),this.declarer=this.firstToBid[c][d],this.suit=c,this.level=b}};Bridge.Contract.prototype.toString=function(){var a="";this.level&&(a+=this.level,a+=this.suit,this.redoubled?a+="xx":this.doubled&&(a+="x"),a+=this.declarer);return a};Bridge||(Bridge={});Bridge.Play=function(a){this.id=(this.deal=a)?a.getID():null;this.plays=[];for(a=0;52>=a;++a)this.plays.push(null);this.lastPlayIndex=-1;this.currentPlayIndex=0;this.cardAdded={};for(var b in Bridge.suits){this.cardAdded[b]={};for(var c in Bridge.ranks)this.cardAdded[b][c]=!1}this.cardPlayed={};for(b in Bridge.suits)for(c in this.cardPlayed[b]={},Bridge.ranks)this.cardPlayed[b][c]=!1;this.leader="w";this.trump="n";this.triggerEvents=!0;this.initialize()};
Bridge.Play.prototype.setID=function(a){Bridge._checkRequiredArgument(a);this.id=a};Bridge.Play.prototype.getID=function(){return this.id};Bridge.Play.prototype.setTrump=function(a){Bridge._checkRequiredArgument(a);Bridge._checkStrain(a);this.trump=a};Bridge.Play.prototype.getTrump=function(){return this.trump};Bridge.Play.prototype.setLeader=function(a){Bridge._checkRequiredArgument(a);Bridge._checkDirection(a);this.leader=a};Bridge.Play.prototype.getLeader=function(){return this.leader};
Bridge.Play.prototype.setPlay=function(a){Bridge._checkRequiredArgument(a);this.fromString(a)};Bridge.Play.prototype.getPlay=function(){return this.toString()};Bridge.Play.prototype.get=function(a){Bridge._checkRequiredArgument(a,"Property","In Play.get");switch(a){case "id":return this.getID();case "trump":return this.getTrump();case "leader":return this.getLeader();case "play":return this.getPlay();default:Bridge._reportError("Unknown deal property "+a,"In Play.get")}};
Bridge.Play.prototype.set=function(a,b){Bridge._checkRequiredArgument(a,"Property","In Play.set");Bridge._checkRequiredArgument(b,"Value for Property "+a,"In Play.set");switch(a){case "id":this.setID(b);break;case "trump":this.setTrump(b);break;case "leader":this.setLeader(b);case "play":this.setPlay(b);break;default:Bridge._reportError("Unknown deal property "+a,"In Play.set")}};
Bridge.Play.prototype.initialize=function(){if(this.deal&&this.deal.getAuction().getContract().isComplete){var a=this.deal.getAuction().getContract();a.isComplete||Bridge._reportError("Cannot initialize play unless auction is complete","Bridge.Play initialize");this.trump=a.getSuit();this.leader=a.getLeader()}this.plays[0]=new Bridge.PlayedCard(0,this.trump,this.leader);this.lastPlayIndex=0};
Bridge.Play.prototype.getNextToPlay=function(){-1===this.lastPlayIndex&&Bridge._reportError("No play entries have been added. Cannot get next to play","Bridge.Play getNextToPlay");return this.plays[this.lastPlayIndex].getNextToPlay()};
Bridge.Play.prototype.addCard=function(a,b,c){a=a.toLowerCase();b=b.toLowerCase();Bridge._checkSuit(a,"In Bridge.Play.addCard");Bridge._checkRank(b,"In Bridge.Play.addCard");var d=this.deal?this.deal.cards[a][b]:new Bridge.Card(a,b),e=this.getNextToPlay();this.deal&&!this.deal.getHand(e).hasCard(a,b)&&Bridge._reportError(a+b+" does not belong to "+e,"In Bridge.Play.addCard");this.cardAdded[a][b]&&Bridge._reportError(a+b+" is already part of play","In Bridge.Play.addCard");c=new Bridge.PlayedCard(this.lastPlayIndex+
1,d,this.plays[this.lastPlayIndex],c);this.plays[this.lastPlayIndex+1]=c;this.lastPlayIndex++;this.cardAdded[a][b]=!0;this.onChange("addCard",c)};
Bridge.Play.prototype.removeCard=function(){if(0<this.lastPlayIndex){var a=this.plays[this.lastPlayIndex];this.plays[this.lastPlayIndex]=null;this.lastPlayIndex--;this.currentPlayIndex>this.lastPlayIndex&&(this.currentPlayIndex=this.lastPlayIndex);this.cardAdded[a.getSuit()][a.getRank()]=!1;this.onChange("removeCard",a)}else Bridge._reportError("No more plays to remove","In Bridge.Play.removeCard")};
Bridge.Play.prototype.playCardTillIndex_=function(a){(1>a||a>this.lastPlayIndex)&&Bridge._reportError("Cannot advance because specified play number "+a+" is invalid","In Bridge.Play.playCardTillIndex_");for(this.currentPlayIndex>=a&&Bridge._reportError("Cannot advance because current play number is at or greater than specified play number "+a,"In Bridge.Play.playCardTillIndex_");this.currentPlayIndex<a;){this.currentPlayIndex++;var b=this.plays[this.currentPlayIndex];this.cardPlayed[b.getSuit()][b.getRank()]=
!0;this.onChange("playCard",b)}this.onChange("playCard:completed",b)};Bridge.Play.prototype.playCard=function(){this.playCardTillIndex_(this.currentPlayIndex+1)};Bridge.Play.prototype.playTrick=function(){for(var a=this.currentPlayIndex+1;0!==a%4;)a++;this.playCardTillIndex_(a)};Bridge.Play.prototype.playAll=function(){this.playCardTillIndex_(this.lastPlayIndex)};
Bridge.Play.prototype.undoPlayCardTillIndex_=function(a){(0>a||a>=this.lastPlayIndex)&&Bridge._reportError("Cannot rewind because specified play number "+a+" is invalid","In Bridge.Play.unplayCardTillIndex_");for(this.currentPlayIndex<=a&&Bridge._reportError("Cannot rewind because current play number is at or lesser than specified play number "+a,"In Bridge.Play.unplayCardTillIndex_");this.currentPlayIndex>a;){var b=this.plays[this.currentPlayIndex];this.currentPlayIndex--;this.cardPlayed[b.getSuit()][b.getRank()]=
!1;this.onChange("undoPlayCard",b)}this.onChange("undoPlayCard:completed",b)};Bridge.Play.prototype.undoPlayCard=function(){this.undoPlayCardTillIndex_(this.currentPlayIndex-1)};Bridge.Play.prototype.undoPlayTrick=function(){for(var a=this.currentPlayIndex-1;0!==a%4;)a--;this.undoPlayCardTillIndex_(a)};Bridge.Play.prototype.undoPlayAll=function(){this.undoPlayCardTillIndex_(0)};Bridge.Play.prototype.rewind=Bridge.Play.prototype.undoPlayAll;Bridge.Play.prototype.clearCards=function(){for(;0<this.lastPlayIndex;)this.removeCard()};
Bridge.Play.prototype.fromString=function(a){this.clearCards();for(var b=0;b<a.length;){var c=a[b++].toLowerCase();b>=a.length&&Bridge._reportError("Play ends unexpectedly on suit with no rank","In Play.fromString");var d=a[b++].toLowerCase(),e=null;"{"===a[b]&&(b=Bridge._parseContainedText(a,b,"}","In Play.fromString"),e=b.text,b=b.position+1);this.addCard(c,d,e)}};Bridge.Play.prototype.fromJSON=function(a){return this.fromString(a)};
Bridge.Play.prototype.toString=function(){for(var a="",b=1;b<=this.lastPlayIndex;++b)a+=this.plays[b].toString();return a};Bridge.Play.prototype.toJSON=function(){return this.toString()};
...
[this.deal,a,b]))};Bridge||(Bridge={});
Bridge.PlayedCard=function(a,b,c,d){var e=_.parseInt(a);(_.isNaN(e)||0>e||52<e)&&Bridge._reportError("Playnumber : "+a+" is not valid!","In Bridge.PlayedCard constructor");0<e&&e!==c.getPlayNumber()+1&&Bridge._reportError("Playnumber : "+a+" does not follow previous playNumber :"+c.getPlayNumber()+"!","In Bridge.PlayedCard constructor");this.playNumber=e;this.leadCard=this.winningCard=this.nextToPlay=null;this.annotation=d;0===e?(Bridge._checkStrain(b),this.trump=b,Bridge._checkDirection(c),this.nextToPlay=
this.leader=c,this.direction=null,this.ewTricks=this.nsTricks=0,this.clearTableCards_()):(this.tableCards=_.clone(c.tableCards),this.nsTricks=c.getNSTricks(),this.ewTricks=c.getEWTricks(),b instanceof Bridge.Card&&c instanceof Bridge.PlayedCard||Bridge._reportError("Invalid card or previousCard!","In Bridge.PlayedCard constructor"),this.card=b,this.previousCard=c,this.trump=this.previousCard.trump,this.leader=this.previousCard.leader,this.direction=this.previousCard.nextToPlay,this.updateInformation_())};
Bridge.PlayedCard.prototype.getCard=function(){return this.card};Bridge.PlayedCard.prototype.getPlayNumber=function(){return this.playNumber};Bridge.PlayedCard.prototype.getTrump=function(){return this.trump};Bridge.PlayedCard.prototype.getLeader=function(){return this.leader};Bridge.PlayedCard.prototype.getSuit=function(){return this.card.getSuit()};Bridge.PlayedCard.prototype.getRank=function(){return this.card.getRank()};Bridge.PlayedCard.prototype.getDirection=function(){return this.direction};
Bridge.PlayedCard.prototype.getNextToPlay=function(){return this.nextToPlay};Bridge.PlayedCard.prototype.getWinningCard=function(){return this.winningCard};Bridge.PlayedCard.prototype.getLeadCard=function(){return this.leadCard};Bridge.PlayedCard.prototype.getNSTricks=function(){return this.nsTricks};Bridge.PlayedCard.prototype.getEWTricks=function(){return this.ewTricks};Bridge.PlayedCard.prototype.clearTableCards_=function(){this.tableCards={};for(var a in Bridge.directions)this.tableCards[a]=null};
Bridge.PlayedCard.prototype.get=function(a){Bridge._checkRequiredArgument(a,"Property","In Call.get");switch(a){case "play_number":return this.getPlayNumber();case "trump":return this.getTrump();case "leader":return this.getLeader();case "card":return this.getCard();case "suit":return this.getSuit();case "rank":return this.getRank();case "direction":return this.getDirection();case "winning_card":return this.getWinningCard();case "lead_card":return this.getLeadCard();case "ns_tricks":return this.getNSTricks();
case "ew_tricks":return this.getEWTricks();case "next_to_play":return this.getNextToPlay();default:Bridge._reportError("Unknown property "+a,"In Call.get")}};
Bridge.PlayedCard.prototype.updateInformation_=function(){this.nextToPlay=this.previousCard?Bridge.getLHO(this.getDirection()):Bridge.getLHO(this.leader);1===this.playNumber%4&&this.clearTableCards_();this.tableCards[this.direction]=this.card;if(1===this.playNumber%4)this.winningCard=this,this.leadCard=this;else{var a=this.previousCard.winningCard;this.leadCard=a.getLeadCard();var b=a.getSuit(),c=a.getRank(),d=this.getSuit(),e=this.getRank(),f=this.trump;b===f?d===f&&Bridge.isHigherRank(e,c)?this.winningCard=
this:this.winningCard=a:d===f||d===b&&Bridge.isHigherRank(e,c)?this.winningCard=this:this.winningCard=a;0===this.playNumber%4&&(a=this.winningCard.getDirection(),Bridge.isNorthSouth(a)?this.nsTricks++:this.ewTricks++,this.nextToPlay=a)}};Bridge.PlayedCard.prototype.toString=function(){var a;a=""+this.card.toString();this.annotation&&(a+="{"+this.annotation+"}");return a};Bridge.Deal.prototype.toHTML=function(){var a;a="<h3>Deal Information</h3>"+("Board : "+this.getBoard()+"<br/>");a+="Dealer : "+Bridge.directions[this.getDealer()].html+"<br/>";a+="Vulnerability : "+Bridge.vulnerabilities[this.getVulnerability()].html+"<br/>";a+="Notes : "+this.getNotes()+"<br/>";a+="<h3>Hands</h3>";for(var b in Bridge.directions)a+=this.getHand(b).toHTML()+"<br/>";a+="<h3>Auction</h3>";return a+=this.getAuction().toHTML()};
