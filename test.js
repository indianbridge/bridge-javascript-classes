...
$(function() {
	try {	
		...
		deal.getHand('n').toBBODiagram( { containerID: 'hand-n' } );
		...
		deal2.getHand('n').toBBODiagram( { containerID: 'hand-s' } );
		deal.fromLIN( linText );
		deal2.fromLIN( linText2 );
		var auction = deal.getAuction();
		auction.toBBODiagram( {containerID: "auction"});
