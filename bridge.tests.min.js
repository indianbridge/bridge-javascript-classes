...
c=b.allowedCalls(d);a.ok(c.p);a.ok(!c.x);a.ok(!c.r);a.ok(c.u);a.ok(c["1c"]);a.ok(c["7n"]);a.equal(c.minimum_level,0);c=["p","p","p","p"];b=new Bridge.Contract;d="n";_.each(c,function(a){a=new Bridge.Call(a,d);d=Bridge.getLHO(d);b.update(a)},this);a.equal(b.level,null,"level matches");a.equal(b.suit,null,"suit matches");a.ok(!b.doubled,"not doubled");a.ok(!b.redoubled,"not redoubled");a.equal(b.declarer,null,"declarer matches");a.equal(b.numPasses,4,"4 passes");a.ok(b.isComplete,"auction iscomplete");
