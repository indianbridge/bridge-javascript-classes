...
QUnit.test("Constructor",function(a){var b=new Bridge.Deal,c;for(c in Bridge.suits)for(var d in Bridge.ranks)a.ok(!b.cards[c][d].isAssigned(),"None of the cards are assigned");a.deepEqual(b.board,1,"board is default");a.deepEqual(b.dealer,"n","dealer is default");a.deepEqual(b.vulnerability,"-","vulnerability is default");a.deepEqual(b.scoring,"KO","vulnerability is default");a.deepEqual(b.notes,"","notes is default");for(var e in Bridge.directions)a.ok(b.hands[e],"Hand objects should exist");a.ok(b.auction,
"Default Auction should exist")});
...
c)},c+" is not a valid hand")});for(b in Bridge.directions){c=new Bridge.Hand(b);e="sakq7hkqtd543cat9";c.set("hand","cat9HKQ10sakq7d453");var d=c.get("name"),f=c.get("count");a.deepEqual(c.get("hand"),e,"hand string should match");var k=c.toJSON(),c=new Bridge.Hand(b);c.fromJSON(k);a.deepEqual(c.get("direction"),b,"direction should match");a.deepEqual(c.get("name"),d,"name should match");a.deepEqual(c.get("count"),f,"count should match");a.deepEqual(c.get("hand"),e,"hand string should match")}});
...
"","handstring matches");c.addCard(d,e);a.ok(c.hasCard(d,e),b+" hand should have "+d+e);a.deepEqual(c.get("count"),1,b+" hand now has 0 cards");a.deepEqual(c.get("hand"),"c2","handstring matches")}});
QUnit.test("Miscellaneous",function(a){var b={sakqj:{count:1,hasCards:{s:!0,h:!1,d:!1,c:!1},output:"shdc"},sakqjhakq:{count:2,hasCards:{s:!0,h:!0,d:!1,c:!1},output:"shdc"},sakqjdakq:{count:2,hasCards:{s:!0,h:!1,d:!0,c:!1},output:"shdc"},sakqjcakq:{count:2,hasCards:{s:!0,h:!1,d:!1,c:!0},output:"shdc"},hakqjdakq:{count:2,hasCards:{s:!1,h:!0,d:!0,c:!1},output:"shdc"},hakqjcakq:{count:2,hasCards:{s:!1,h:!0,d:!1,c:!0},output:"shdc"},dakqjcakq:{count:2,hasCards:{s:!1,h:!1,d:!0,c:!0},output:"shdc"},sahada:{count:3,
hasCards:{s:!0,h:!0,d:!0,c:!1},output:"hscd"},sahaca:{count:3,hasCards:{s:!0,h:!0,d:!1,c:!0},output:"shdc"},sadaca:{count:3,hasCards:{s:!0,h:!1,d:!0,c:!0},output:"shdc"},hadaca:{count:3,hasCards:{s:!1,h:!0,d:!0,c:!0},output:"hscd"},sahadaca:{count:4,hasCards:{s:!0,h:!0,d:!0,c:!0},output:"shcd"}},c;for(c in Bridge.directions)for(var d in b){var e=new Bridge.Hand(c);e.set("hand",d);for(var f in Bridge.suits)a.equal(b[d].hasCards[f],e._hasCards(f),"has cards matches for "+d+" in suit "+f);a.equal(b[d].output,
e.getAlternatingSuitOrder().join(""),"suit order for "+d+" matches")}});QUnit.module("Bridge.Call");
QUnit.test("Constructor",function(a){a.throws(function(){new Bridge.Call},"Bridge.Call constructor needs 2 arguments");a.throws(function(){new Bridge.Call("a")},"Bridge.Call constructor needs valid call argument");a.throws(function(){new Bridge.Call("p")},"Bridge.Call constructor needs second argument");for(var b in Bridge.directions){for(var c=1;7>=c;++c)for(var d in Bridge.calls)if(Bridge.isStrain(d)){var e=new Bridge.Call(c+d,b);a.equal(e.get("direction"),b,"Direction matches");a.equal(e.get("call"),
...
"","Explanation matches"))}});
QUnit.test("Getter and Setter",function(a){var b="p",c,b=new Bridge.Call(b,"n");a.throws(function(){b.set()},"Bridge.Call.set needs property argument");a.throws(function(){b.set("name")},"Bridge.Call.set needs a value argument");a.throws(function(){b.set("random_property","value")},"Bridge.Call.set valid property");a.throws(function(){b.get()},"Bridge.Call.get needs property argument");a.throws(function(){b.get("random_property")},"Bridge.Call.get needs a known property argument");b.set("annotation",
...
a.equal(b.get("auction"),"p1cx3nppp","auction matches");a.equal(b.get("contract").toString(),"3nw","contract matches");b.removeCall();b.removeCall();b.addAllPass();a.equal(b.get("auction"),"p1cx3nppp","auction matches");a.equal(b.get("contract").toString(),"3nw","contract matches");b.removeCall();b.removeCall();b.removeCall();b.addAllPass();a.equal(b.get("auction"),"p1cx3nppp","auction matches");a.equal(b.get("contract").toString(),"3nw","contract matches")});
QUnit.test("advance rewind calls",function(a){var b=new Bridge.Auction;a.equal(b.currentAuctionIndex,-1,"auction index matches");b.set("auction","p1h2d4dp4sp6cp6hppp");b.advanceAuction();a.equal(b.currentAuctionIndex,0,"auction index matches");b.advanceAuctionAll();a.equal(b.currentAuctionIndex,12,"auction index matches");a.throws(function(){b.advanceAuction()},"auction advanced fully");a.throws(function(){b.advanceAuctionAll()},"auction advanced fully");b.rewindAuction();a.equal(b.currentAuctionIndex,
11,"auction index matches");b.rewindAuctionAll();a.equal(b.currentAuctionIndex,-1,"auction index matches");a.throws(function(){b.rewindAuction()},"auction rewinded fully");a.throws(function(){b.rewindAuctionAll()},"auction rewinded fully")});QUnit.module("Bridge.Contract");QUnit.test("Constructor",function(a){var b=new Bridge.Contract;a.equal(b.level,null,"level is null");a.equal(b.suit,null,"suit is null");a.ok(!b.doubled,"not doubled");a.ok(!b.redoubled,"not redoubled");a.equal(b.declarer,null,"declarer is null");for(var c in Bridge.calls)for(var d in Bridge.directions)Bridge.isStrain(c)&&a.equal(b.firstToBid[c][d],null,"First bid for "+c+d+" is null");a.equal(b.numPasses,0,"0 passes");a.ok(!b.isComplete,"auction not complete")});
...
"redoubled");a.equal(b.declarer,"w","declarer matches");a.equal(b.firstToBid.c.n,"n","First bid for c is n");a.equal(b.firstToBid.c.s,"n","First bid for c is n");a.equal(b.firstToBid.h.e,"w","First bid for c is n");a.equal(b.firstToBid.h.w,"w","First bid for c is n");a.equal(b.numPasses,3,"1 passes");a.ok(b.isComplete,"auction is complete");c=b.allowedCalls(d);a.ok(!c.p);a.ok(!c.x);a.ok(!c.r);a.ok(c.u);a.ok(!c["1c"]);a.ok(!c["7n"]);a.equal(c.minimum_level,8)});QUnit.module("Bridge.PlayedCard");
QUnit.test("Constructor",function(a){a.throws(function(){new Bridge.PlayedCard},"Bridge.PlayedCard constructor needs at least 3 arguments");a.throws(function(){new Bridge.PlayedCard(1)},"Bridge.PlayedCard constructor needs at least 3 arguments");var b=new Bridge.Card("s","8");a.throws(function(){new Bridge.PlayedCard(1,b)},"Bridge.PlayedCard constructor needs at least 3 arguments");for(var c in Bridge.directions)for(var d in Bridge.calls)if(Bridge.isStrain(d))var e=new Bridge.PlayedCard(0,d,c);else a.throws(function(){new Bridge.PlayedCard(0,
d,c)},"Bridge.PlayedCard constructor "+d+" is invalid trump suit");a.throws(function(){new Bridge.PlayedCard(0,"s","a")},"Bridge.PlayedCard constructor invalid leader");d="s";c="w";var f=new Bridge.PlayedCard(0,d,c),k;for(k in Bridge.suits)for(var l in Bridge.ranks)b=new Bridge.Card(k,l),e=new Bridge.PlayedCard(1,b,f),a.equal(e.get("play_number"),1,"PlayNumber matches"),a.equal(e.get("trump"),d,"Trump matches"),a.equal(e.get("leader"),c,"Direction matches"),a.equal(e.get("card"),b,"Card matches"),
a.equal(e.get("suit"),b.getSuit(),"Suit matches"),a.equal(e.get("rank"),b.getRank(),"Rank matches"),a.equal(e.get("direction"),c,"Direction matches"),a.equal(e.get("winning_card"),e,"Winning Card matches"),a.equal(e.get("lead_card"),e,"lead Card matches"),a.equal(e.previousCard,f,"previous Card matches"),a.deepEqual(e.tableCards,{n:null,e:null,s:null,w:b},"table cards match");b=new Bridge.Card("h","a");a.throws(function(){new Bridge.PlayedCard(2,b,f)},"Bridge.PlayedCard constructor play number not in sequence");
var g=[],h=[];g.push(f);_.each(["ha","h2","s2","h3","dk"],function(a,b){var c=new Bridge.Card(a[0],a[1]);h.push(c);c=new Bridge.PlayedCard(b+1,c,g[b]);g.push(c)});nextPlayedCard=g[1];a.equal(nextPlayedCard.get("play_number"),1,"PlayNumber matches");a.equal(nextPlayedCard.get("trump"),d,"Trump matches");a.equal(nextPlayedCard.get("leader"),c,"Leader matches");a.equal(nextPlayedCard.get("suit"),"h","Suit matches");a.equal(nextPlayedCard.get("rank"),"a","Rank matches");a.equal(nextPlayedCard.get("direction"),
"w","Direction matches");a.equal(nextPlayedCard.get("winning_card"),g[1],"Winning Card matches");a.equal(nextPlayedCard.get("lead_card"),g[1],"lead Card matches");a.equal(nextPlayedCard.previousCard,f,"previous Card matches");a.equal(nextPlayedCard.nextToPlay,"n","next to play matches");a.deepEqual(nextPlayedCard.tableCards,{n:null,e:null,s:null,w:h[0]},"table cards match");nextPlayedCard=g[2];a.equal(nextPlayedCard.get("play_number"),2,"PlayNumber matches");a.equal(nextPlayedCard.get("trump"),d,
"Trump matches");a.equal(nextPlayedCard.get("leader"),c,"Leader matches");a.equal(nextPlayedCard.get("suit"),"h","Suit matches");a.equal(nextPlayedCard.get("rank"),"2","Rank matches");a.equal(nextPlayedCard.get("direction"),"n","Direction matches");a.equal(nextPlayedCard.get("winning_card"),g[1],"Winning Card matches");a.equal(nextPlayedCard.get("lead_card"),g[1],"lead Card matches");a.equal(nextPlayedCard.previousCard,g[1],"previous Card matches");a.equal(nextPlayedCard.nextToPlay,"e","next to play matches");
a.deepEqual(nextPlayedCard.tableCards,{n:h[1],e:null,s:null,w:h[0]},"table cards match");nextPlayedCard=g[3];a.equal(nextPlayedCard.get("play_number"),3,"PlayNumber matches");a.equal(nextPlayedCard.get("trump"),d,"Trump matches");a.equal(nextPlayedCard.get("leader"),c,"Leader matches");a.equal(nextPlayedCard.get("suit"),"s","Suit matches");a.equal(nextPlayedCard.get("rank"),"2","Rank matches");a.equal(nextPlayedCard.get("direction"),"e","Direction matches");a.equal(nextPlayedCard.get("winning_card"),
g[3],"Winning Card matches");a.equal(nextPlayedCard.get("lead_card"),g[1],"lead Card matches");a.equal(nextPlayedCard.previousCard,g[2],"previous Card matches");a.equal(nextPlayedCard.nextToPlay,"s","next to play matches");a.deepEqual(nextPlayedCard.tableCards,{n:h[1],e:h[2],s:null,w:h[0]},"table cards match");nextPlayedCard=g[4];a.equal(nextPlayedCard.get("play_number"),4,"PlayNumber matches");a.equal(nextPlayedCard.get("trump"),d,"Trump matches");a.equal(nextPlayedCard.get("leader"),c,"Leader matches");
a.equal(nextPlayedCard.get("suit"),"h","Suit matches");a.equal(nextPlayedCard.get("rank"),"3","Rank matches");a.equal(nextPlayedCard.get("direction"),"s","Direction matches");a.equal(nextPlayedCard.get("winning_card"),g[3],"Winning Card matches");a.equal(nextPlayedCard.get("lead_card"),g[1],"lead Card matches");a.equal(nextPlayedCard.previousCard,g[3],"previous Card matches");a.equal(nextPlayedCard.nextToPlay,"e","next to play matches");a.deepEqual(nextPlayedCard.tableCards,{n:h[1],e:h[2],s:h[3],
w:h[0]},"table cards match");nextPlayedCard=g[5];a.equal(nextPlayedCard.get("play_number"),5,"PlayNumber matches");a.equal(nextPlayedCard.get("trump"),d,"Trump matches");a.equal(nextPlayedCard.get("leader"),c,"Leader matches");a.equal(nextPlayedCard.get("suit"),"d","Suit matches");a.equal(nextPlayedCard.get("rank"),"k","Rank matches");a.equal(nextPlayedCard.get("direction"),g[3].getDirection(),"Direction matches");a.equal(nextPlayedCard.get("winning_card"),g[5],"Winning Card matches");a.equal(nextPlayedCard.get("lead_card"),
g[5],"lead Card matches");a.equal(nextPlayedCard.get("ns_tricks"),0,"ns tricks matches");a.equal(nextPlayedCard.get("ew_tricks"),1,"ew tricks matches");a.equal(nextPlayedCard.previousCard,g[4],"previous Card matches");a.equal(nextPlayedCard.nextToPlay,"s","next to play matches");a.deepEqual(nextPlayedCard.tableCards,{n:null,e:h[4],s:null,w:null},"table cards match")});
