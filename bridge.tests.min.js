...
"Bad suit specified should throw exception");for(var b=["n","s","h","d","c"],c=0;c<b.length;++c)a.ok(Bridge.isBid(b[c]),b[c]+" is a bid");b="p;x;r;a;; ".split(";");for(c=0;c<b.length;++c)a.ok(!Bridge.isBid(b[c]),b[c]+" is not a bid")});
...
QUnit.test("reportError",function(a){a.throws(function(){Bridge._reportError("Some Error")},function(b){return"Some Error"===b.message},"raised error instance satisfies the callback function");a.throws(function(){Bridge._reportError("Some Error","Test")},function(b){return"Some Error"===b.message},"raised error instance satisfies the callback function");Bridge.options.useContextInErrorMessage=!0;a.throws(function(){Bridge._reportError("Some Error","Test")},function(b){return"Test - Some Error"===
b.message},"raised error instance satisfies the callback function")});
...
c=b.allowedCalls(d);a.ok(c.p);a.ok(!c.x);a.ok(!c.r);a.ok(c.u);a.ok(c["1c"]);a.ok(c["7n"]);c=["p","p","p","p"];b=new Bridge.Contract;d="n";_.each(c,function(a){a=new Bridge.Call(a,d);d=Bridge.getLHO(d);b.update(a)},this);a.equal(b.level,null,"level matches");a.equal(b.suit,null,"suit matches");a.ok(!b.doubled,"not doubled");a.ok(!b.redoubled,"not redoubled");a.equal(b.declarer,null,"declarer matches");a.equal(b.numPasses,4,"4 passes");a.ok(b.isComplete,"auction iscomplete");c=b.allowedCalls(d);a.ok(!c.p);
a.ok(!c.x);a.ok(!c.r);a.ok(c.u);a.ok(!c["1c"]);a.ok(!c["7n"]);c=["1c","p","p","1h","p"];b=new Bridge.Contract;d="n";_.each(c,function(a){a=new Bridge.Call(a,d);d=Bridge.getLHO(d);b.update(a)},this);a.equal(b.level,1,"level matches");a.equal(b.suit,"h","suit matches");a.ok(!b.doubled,"not doubled");a.ok(!b.redoubled,"not redoubled");a.equal(b.declarer,"w","declarer matches");a.equal(b.firstToBid.c.n,"n","First bid for c is n");a.equal(b.firstToBid.c.s,"n","First bid for c is n");a.equal(b.firstToBid.h.e,
"w","First bid for c is n");a.equal(b.firstToBid.h.w,"w","First bid for c is n");a.equal(b.numPasses,1,"1 passes");a.ok(!b.isComplete,"auction not complete");c=b.allowedCalls(d);a.ok(c.p);a.ok(!c.x);a.ok(!c.r);a.ok(c.u);a.ok(!c["1h"]);a.ok(c["1s"]);c="1c p p 1h p 2h".split(" ");b=new Bridge.Contract;d="n";_.each(c,function(a){a=new Bridge.Call(a,d);d=Bridge.getLHO(d);b.update(a)},this);a.equal(b.level,2,"level matches");a.equal(b.suit,"h","suit matches");a.ok(!b.doubled,"not doubled");a.ok(!b.redoubled,
"not redoubled");a.equal(b.declarer,"w","declarer matches");a.equal(b.firstToBid.c.n,"n","First bid for c is n");a.equal(b.firstToBid.c.s,"n","First bid for c is n");a.equal(b.firstToBid.h.e,"w","First bid for c is n");a.equal(b.firstToBid.h.w,"w","First bid for c is n");a.equal(b.numPasses,0,"0 passes");a.ok(!b.isComplete,"auction not complete");c=b.allowedCalls(d);a.ok(c.p);a.ok(c.x);a.ok(!c.r);a.ok(c.u);a.ok(!c["2h"]);a.ok(c["2s"]);c="1h p p 2h p 3h x p p".split(" ");b=new Bridge.Contract;d="n";
_.each(c,function(a){a=new Bridge.Call(a,d);d=Bridge.getLHO(d);b.update(a)},this);a.equal(b.level,3,"level matches");a.equal(b.suit,"h","suit matches");a.ok(b.doubled,"doubled");a.ok(!b.redoubled,"not redoubled");a.equal(b.declarer,"w","declarer matches");a.equal(b.firstToBid.h.n,"n","First bid for c is n");a.equal(b.firstToBid.h.s,"n","First bid for c is n");a.equal(b.firstToBid.h.e,"w","First bid for c is n");a.equal(b.firstToBid.h.w,"w","First bid for c is n");a.equal(b.numPasses,2,"2 passes");
a.ok(!b.isComplete,"auction not complete");c=b.allowedCalls(d);a.ok(c.p);a.ok(!c.x);a.ok(c.r);a.ok(c.u);a.ok(!c["2h"]);a.ok(c["3s"]);c="1c p p 1h p 2h x r p p p".split(" ");b=new Bridge.Contract;d="n";_.each(c,function(a){a=new Bridge.Call(a,d);d=Bridge.getLHO(d);b.update(a)},this);a.equal(b.level,2,"level matches");a.equal(b.suit,"h","suit matches");a.ok(b.doubled,"doubled");a.ok(b.redoubled,"redoubled");a.equal(b.declarer,"w","declarer matches");a.equal(b.firstToBid.c.n,"n","First bid for c is n");
a.equal(b.firstToBid.c.s,"n","First bid for c is n");a.equal(b.firstToBid.h.e,"w","First bid for c is n");a.equal(b.firstToBid.h.w,"w","First bid for c is n");a.equal(b.numPasses,3,"1 passes");a.ok(b.isComplete,"auction is complete");c=b.allowedCalls(d);a.ok(!c.p);a.ok(!c.x);a.ok(!c.r);a.ok(c.u);a.ok(!c["1c"]);a.ok(!c["7n"])});
