...
Bridge.Contract.prototype.allowedCalls=function(a){Bridge._checkDirection(a);var b={};b.p=!this.isComplete;b.ap=b.p;b.x=!1;b.r=!1;for(var c=1;7>=c;++c)for(var d in Bridge.calls)Bridge.isBid(d)&&(b[c+d]=!this.isComplete);b.u=!(null===this.suit&&0===this.numPasses);b.minimum_level=8;if(null===this.suit||this.isComplete)return this.isComplete||(b.minimum_level=1),b;for(c=1;7>=c;++c)for(d in Bridge.calls)Bridge.isBid(d)&&(c>this.level||c===this.level&&Bridge.calls[d].index<Bridge.calls[this.suit].index?
...
Bridge.embedHTML=function(a,b){a&&0!==$("#"+a).length?$("#"+a).empty().append(b):Bridge._reportError("In trying to embed html into "+a+" - No container id has been specified or the container id does not exist!")};
Bridge.Hand.prototype.toHTML=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{type:"html",direction:"n",idPrefix:null,showName:!1,showDirection:!0,embed:!1,containerID:null,registerChangeHandler:!1});if("BBO"===a.type)var c=this._toBBODiagram(a);else c="",_.each(Bridge.suitOrder,function(a){c+=Bridge.suits[a].html+" ";var b="";_.each(Bridge.rankOrder,function(c){this.cards[a][c]&&(b+=Bridge.ranks[c].html)},this);b&&(c+=b+" ")},this);a.embed&&Bridge.embedHTML(a.containerID,
c);if(!b&&a.registerChangeHandler)$(document).on("hand:changed",{config:_.clone(a)},function(b,c){c.getDirection()===a.direction&&c.toHTML(b.data.config,!0)});return c};
Bridge.Hand.prototype._toBBODiagram=function(a){a=Bridge.assignDefault(a,{});_.defaults(a,{idPrefix:null,showName:!1,showDirection:!0,embed:!1,containerID:null});var b="",c="hand-diagram-div",d=a.idPrefix?a.idPrefix+"-"+c:null,b=b+("<div"+Bridge.addClassAndId(c,d)+">"),c="hand-diagram-table";this._isActive&&(c+=" active");d=a.idPrefix?a.idPrefix+"-"+c:null;b+="<table"+Bridge.addClassAndId(c,d)+">";a.showDirection&&(c="hand-diagram-info",b+="<thead"+Bridge.addClassAndId(c)+">",b+="<tr>",c="hand-diagram-direction",
b+="<td"+Bridge.addClassAndId(c)+">"+this.getDirection().toUpperCase()+"</td>",c="hand-diagram-name",a=a.showName?this.getName():"",b+="<td"+Bridge.addClassAndId(c)+">"+a+"</td>",b+="</tr></thead>");c="hand-diagram-cards";b+="<tbody"+Bridge.addClassAndId(c)+">";_.each(Bridge.suitOrder,function(a){b+="<tr>";c="hand-diagram-suit";b+="<td data-suit='"+a+"'"+Bridge.addClassAndId(c)+">"+Bridge.suits[a].html+"</td>";var d="";c="hand-diagram-card";_.each(Bridge.rankOrder,function(b){this.cards[a][b]&&(d+=
"<span data-card='"+a+b+"'"+Bridge.addClassAndId(c)+">"+Bridge.ranks[b].html+"</span>")},this);c="hand-diagram-suit-cards";b+="<td"+Bridge.addClassAndId(c)+">"+d+"</td>";b+="</tr>"},this);return b+="</tbody></table></div>"};
Bridge.Auction.prototype.toHTML=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{type:"html",idPrefix:null,addQuestionMark:!0});if("BBO"===a.type)var c=this._toBBODiagram(a);else{for(var c="Auction: ",d=0;d<this.calls.length;++d)c+=this.calls[d].toHTML()+" ";this.getContract().isComplete&&(c+="<br/>Contract: "+this.getContract().toHTML())}a.embed&&Bridge.embedHTML(a.containerID,c);!b&&a.registerChangeHandler&&(console.log("registering container = "+a.containerID),
$(document).on("auction:changed",{config:_.clone(a)},function(a,b){b.toHTML(a.data.config,!0)}));return c};Bridge.addClassAndId=function(a,b){var c="";b&&(c+=" id='"+b+"'");return c+(" class='"+a+"'")};
Bridge.Auction.prototype._toBBODiagram=function(a){a=Bridge.assignDefault(a,{});_.defaults(a,{idPrefix:null,addQuestionMark:!0});var b="",c="auction-diagram-div",d=a.idPrefix?a.idPrefix+"-"+c:null,b=b+("<div"+Bridge.addClassAndId(c,d)+">"),c="auction-diagram-table",d=a.idPrefix?a.idPrefix+"-"+c:null,b=b+("<table"+Bridge.addClassAndId(c,d)+">"),c="auction-diagram-directions",b=b+("<thead"+Bridge.addClassAndId(c)+">"),b=b+"<tr>",e=this.vulnerability;_.each(Bridge.directionOrder,function(a){c="auction-diagram-direction-"+
a+" vulnerability-";c="b"==e||e==a||e==Bridge.getPartner(a)?c+"red":c+"white";b+="<th data-direction='"+a+"' "+Bridge.addClassAndId(c)+">"+a.toUpperCase()+"</th>"},this);for(var b=b+"</tr></thead>",c="auction-diagram-calls",b=b+("<tbody"+Bridge.addClassAndId(c)+">"),b=b+"<tr>",c="auction-diagram-call",d="w",f=!0;this.dealer!==d;)f=!1,d=Bridge.getLHO(d),b+="<td data-call=''"+Bridge.addClassAndId(c)+"></td>";for(var h=0;h<this.calls.length;++h){var l=this.calls[h],d=l.getDirection();"w"===d&&(f||(b+=
"</tr><tr>"));b+="<td data-call='"+l.toString()+"'"+Bridge.addClassAndId(c)+">"+l.toHTML()+"</td>";f=!1}0<this.calls.length&&(d=Bridge.getLHO(d));!this.getContract().isComplete&&a.addQuestionMark&&("w"===d&&(b+="</tr><tr>"),b+="<td data-call='?'"+Bridge.addClassAndId(c)+">?</td>",d=Bridge.getLHO(d));for(;"w"!==d;)b+="<td data-call=''"+Bridge.addClassAndId(c)+"></td>",d=Bridge.getLHO(d);return b+="</tr></tbody></table></div>"};
...
Bridge.Deal.prototype.toCardDeck=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{type:"html",idPrefix:null,embed:!1,containerID:null,registerChangeHandler:!1,elementData:[],elementClasses:[],imagesPath:"",showCardback:!1});if("images"===a.type){var c="card-deck-div",d=a.idPrefix?a.idPrefix+"-"+c:null,e="",e=e+("<div"+Bridge.addClassAndId(c,d)+">");_.each(Bridge.suitOrder,function(b){c="card-deck-row card-deck-row-"+b;e+="<div"+Bridge.addClassAndId(c)+">";_.each(Bridge.rankOrder,
function(c){var d=_.clone(a.elementClasses);d.push("card-deck-card-image");var g=_.clone(a.elementData);g.push("data-card='"+b+c+"'");var k=this._cardAssignedTo[b][c];k?(d.push("card-deck-card-image-assigned"),g.push("data-assignedto='"+k+"'"),c=a.imagesPath+"cb.png",k="Click to remove from "+Bridge.directions[k].name+" hand"):(g.push("data-assignedto=''"),d.push("card-deck-card-image-unassigned"),c=a.imagesPath+b+c+".png",k="Click to add to "+Bridge.directions[this.getActiveHand()].name+" hand");
e+="<img ";a.height&&(e+="height="+a.height);a.width&&(e+="width="+a.width);e+=" title='"+k+"' src='"+c+"' class='"+d.join(" ")+"' "+g.join(" ")+"/>"},this)},this)}else c="card-deck-div",d=a.idPrefix?a.idPrefix+"-"+c:null,e="",e+="<div"+Bridge.addClassAndId(c,d)+">",_.each(Bridge.suitOrder,function(b){c="card-deck-row card-deck-row-"+b;e+="<div"+Bridge.addClassAndId(c)+">";_.each(Bridge.rankOrder,function(c){var d=Bridge.suits[b].html+Bridge.ranks[c].html,g=_.clone(a.elementClasses),k=_.clone(a.elementData),
m=this._cardAssignedTo[b][c];m?(g.push("card-deck-card-assigned"),k.push("data-assignedto='"+m+"'"),d+="("+m+")"):(k.push("data-assignedto=''"),g.push("card-deck-card-unassigned"));e+=Bridge._makeElement({prefix:"card-deck",elementType:"card",data:k,classes:g,value:b+c,disabled:!1,text:d,idPrefix:a.idPrefix})},this)},this);e+="</div>";e+="</div>";a.embed&&Bridge.embedHTML(a.containerID,e);!b&&a.registerChangeHandler&&($(document).on("click",".card-deck-card",{deal:this},function(a){var b=$(this).data("card"),
c=$(this).data("assignedto");console.log("Card is "+b);console.log("Assigned To is "+c);c?a.data.deal.getHand(c).removeCard(b[0],b[1]):a.data.deal.getHand(a.data.deal.getActiveHand()).addCard(b[0],b[1])}),$(document).on("click",".card-deck-card-image",{deal:this},function(a){var b=$(this).data("card"),c=$(this).data("assignedto");console.log("Card is "+b);console.log("Assigned To is "+c);c?a.data.deal.getHand(c).removeCard(b[0],b[1]):a.data.deal.getHand(a.data.deal.getActiveHand()).addCard(b[0],b[1])}),
$(document).on("hand:changed",{deal:this,config:_.clone(a)},function(a,b){a.data.deal.toCardDeck(a.data.config,!0)}));return e};
Bridge._makeElement=function(a){_.defaults(a,{type:"button",text:"Click Me!",classes:[],data:[],idPrefix:null,prefix:"bidding-box",elementType:"call"});a.classes.push(a.prefix+"-"+a.elementType);a.classes.push(a.prefix+"-"+a.elementType+"-"+a.value);a.id=a.idPrefix?a.idPrefix+"-"+a.prefix+"-"+a.elementType+"-"+a.value:null;a.data.push("data-"+a.elementType+"='"+a.value+"'");a.disabled&&a.classes.push(a.prefix+"-"+a.elementType+"-disabled");var b;b="<"+a.type;a.id&&(b+=" id='"+a.id+"'");b+=" class='"+
a.classes.join(" ")+"'";b+=" "+a.data.join(" ");a.disabled&&(b+=" disabled");return b+=">"+a.text+"</"+a.type+">"};
Bridge.Auction.prototype.toBiddingBox=function(a,b){b=Bridge.assignDefault(b,!1);a=Bridge.assignDefault(a,{});_.defaults(a,{type:"full",idPrefix:null,embed:!1,containerID:null,registerChangeHandler:!1,includeAllPass:!1,includeUndo:!1,includeReset:!1,elementData:[],elementClasses:[]});var c="concise"===a.type?this._createBBOBiddingBox(a):this._createFullBiddingBox(a),d=this;a.embed&&Bridge.embedHTML(a.containerID,c);!b&&a.registerChangeHandler&&($(document).on("click",".bidding-box-level",function(){var a=
$(this).data("level");d.setSelectedLevel(a)}),$(document).on("click",".bidding-box-call",function(){var a=$(this).data("call");"all_pass"===a?d.addAllPass():"undo"===a?d.removeCall():"reset"===a?d.clearCalls():Bridge.isBid(a)?d.addCall(d.getSelectedLevel()+a):d.addCall(a)}),$(document).on("bidding-box:changed",{config:_.clone(a)},function(a,b){b.toBiddingBox(a.data.config,!0)}));return c};
Bridge.Auction.prototype._createFullBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),c="bidding-box-div",d="",d=d+("<div"+Bridge.addClassAndId(c,a.idPrefix?a.idPrefix+"-"+c:null)+">"),d=d+("<div"+Bridge.addClassAndId("bidding-box-row")+">");_.each(Bridge.callOrder,function(c){if(!Bridge.isBid(c)){var e=Bridge.calls[c].name,l=_.clone(a.elementClasses),g=_.clone(a.elementData);d+=Bridge._makeElement({data:g,classes:l,value:c,disabled:!b[c],text:e,idPrefix:a.idPrefix})}},
this);for(var d=d+"</div>",c="bidding-box-row",e=1;7>=e;++e)d+="<div"+Bridge.addClassAndId(c)+">",_.each(Bridge.callOrder.slice().reverse(),function(c){if(Bridge.isBid(c)){var h=e+c;c=e+Bridge.calls[c].html;var l=_.clone(a.elementClasses),g=_.clone(a.elementData);d+=Bridge._makeElement({data:g,classes:l,value:h,disabled:!b[h],text:c,idPrefix:a.idPrefix})}},this),d+="</div>";d+="<div"+Bridge.addClassAndId("bidding-box-row")+">";_.each([{call:"all_pass",text:"All Pass",field:"p",include:a.includeAllPass},
{call:"undo",text:"Undo",field:"u",include:a.includeUndo},{call:"reset",text:"Reset",field:"u",include:a.includeReset}],function(c){if(c.include){var e=_.clone(a.elementClasses),l=_.clone(a.elementData);d+=Bridge._makeElement({data:l,classes:e,value:c.call,disabled:!b[c.field],text:c.text,idPrefix:a.idPrefix})}},this);d+="</div>";return d+="</div>"};
Bridge.Auction.prototype._createBBOBiddingBox=function(a){var b=this.getContract().allowedCalls(this.nextToCall),c=this.getSelectedLevel(),d="bidding-box-div",e="",e=e+("<div"+Bridge.addClassAndId(d,a.idPrefix?a.idPrefix+"-"+d:null)+">"),e=e+("<div"+Bridge.addClassAndId("bidding-box-row")+">");_.each(Bridge.callOrder,function(c){if(!Bridge.isBid(c)){var d=Bridge.calls[c].name,f=_.clone(a.elementClasses),g=_.clone(a.elementData);e+=Bridge._makeElement({data:g,classes:f,value:c,disabled:!b[c],text:d,
idPrefix:a.idPrefix})}},this);for(var e=e+"</div>",e=e+("<div"+Bridge.addClassAndId("bidding-box-row")+">"),f=b.minimum_level,h=1;7>=h;++h){var l=h,g=h,d=_.clone(a.elementClasses),k=_.clone(a.elementData);h===c&&d.push("bidding-box-call-selected");e+=Bridge._makeElement({elementType:"level",data:k,classes:d,value:l,disabled:!(h>=f),text:g,idPrefix:a.idPrefix})}e+="</div>";e+="<div"+Bridge.addClassAndId("bidding-box-row")+">";_.each(Bridge.callOrder.slice().reverse(),function(d){if(Bridge.isBid(d)){var f=
Bridge.calls[d].html,g=_.clone(a.elementClasses),h=_.clone(a.elementData);e+=Bridge._makeElement({data:h,classes:g,value:d,disabled:!(c&&b[c+d]),text:f,idPrefix:a.idPrefix})}},this);e+="</div>";e+="<div"+Bridge.addClassAndId("bidding-box-row")+">";_.each([{call:"all_pass",text:"All Pass",field:"p",include:a.includeAllPass},{call:"undo",text:"Undo",field:"u",include:a.includeUndo},{call:"reset",text:"Reset",field:"u",include:a.includeReset}],function(c){if(c.include){var d=_.clone(a.elementClasses),
f=_.clone(a.elementData);e+=Bridge._makeElement({data:f,classes:d,value:c.call,disabled:!b[c.field],text:c.text,idPrefix:a.idPrefix})}},this);e+="</div>";return e+="</div>"};
