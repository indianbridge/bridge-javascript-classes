...
Bridge._checkRank=function(a,b){Bridge._checkListMembership(a,Bridge.ranks,"Rank",b)};Bridge._checkVulnerability=function(a,b){Bridge._checkListMembership(a,Bridge.vulnerabilities,"Vulnerability",b)};Bridge||(Bridge={});Bridge.Deal=function(){this._cardAssignedTo={};for(var a in Bridge.suits){this._cardAssignedTo[a]={};for(var b in Bridge.ranks)this._cardAssignedTo[a][b]=null}this.hands={};for(var c in Bridge.directions)this.hands[c]=new Bridge.Hand(c,this);this.board=1;this.vulnerability="-";this.dealer="n";this.scoring="IMP";this.notes="";this.auction=new Bridge.Auction(this)};Bridge.Deal.prototype.getHand=function(a){Bridge._checkDirection(a);return this.hands[a]};
Bridge.Deal.prototype.getBoard=function(){return this.board};Bridge.Deal.prototype.setBoard=function(a){var b=parseInt(a);(isNaN(b)||String(b)!==String(a)||1>b)&&Bridge.Utilities.reportError(a+" is not a valid board number","In setBoard");this.board=b};Bridge.Deal.prototype.getDealer=function(){return this.dealer};Bridge.Deal.prototype.setDealer=function(a){a=a.toLowerCase();Bridge._checkDirection(a);this.dealer=a};Bridge.Deal.prototype.getVulnerability=function(){return this.vulnerability};
Bridge.Deal.prototype.setVulnerability=function(a){a=a.toLowerCase();"0"===a&&(a="-");Bridge._checkVulnerability(a);this.vulnerability=a};Bridge.Deal.prototype.getScoring=function(){return this.scoring};Bridge.Deal.prototype.setScoring=function(a){Bridge._checkRequiredArgument(a);this.scoring=a};Bridge.Deal.prototype.getNotes=function(){return this.notes};Bridge.Deal.prototype.setNotes=function(a){Bridge._checkRequiredArgument(a);this.notes=a};Bridge.Deal.prototype.getAuction=function(){return this.auction};
...
Bridge.Deal.prototype.toJSON=function(){var a={};_.each(["board","dealer","vulnerability","scoring","notes"],function(b){a[b]=this.get(b)},this);a.hands={};for(var b in Bridge.directions){var c=this.getHand(b);a.hands[b]=c.toJSON()}a.auction=this.auction.toJSON();return a};
Bridge.Deal.prototype.fromJSON=function(a){_.each(["board","dealer","vulnerability","scoring","notes"],function(b){_.has(a,b)&&this.set(b,a[b])},this);if(_.has(a,"hands"))for(var b in Bridge.directions)_.has(a.hands,b)&&this.getHand(b).fromJSON(a.hands[b]);_.has(a,"auction")&&this.auction.fromJSON(a.auction)};
Bridge.Deal.prototype.toHTML=function(){var a;a="<h3>Deal Information</h3>"+("Board : "+this.getBoard()+"<br/>");a+="Dealer : "+Bridge.directions[this.getDealer()].html+"<br/>";a+="Vulnerability : "+Bridge.vulnerabilities[this.getVulnerability()].html+"<br/>";a+="Notes : "+this.getNotes()+"<br/>";a+="<h3>Hands</h3>";for(var b in Bridge.directions)a+=this.getHand(b).toHTML()+"<br/>";a+="<h3>Auction</h3>";return a+=this.getAuction().toHTML()};Bridge||(Bridge={});Bridge.Hand=function(a,b){Bridge._checkDirection(a);this.direction=a;this.deal=b;this.name=Bridge.directions[a].name;this.cards={};for(var c in Bridge.suits){this.cards[c]={};for(var d in Bridge.ranks)this.cards[c][d]=!1}this.numCards=0};Bridge.Hand.prototype.getDirection=function(){return this.direction};Bridge.Hand.prototype.setName=function(a){Bridge._checkRequiredArgument(a);this.name=a};Bridge.Hand.prototype.getName=function(){return this.name};
...
Bridge.Call.prototype.toString=function(){var a;a=""+this.call;this.explanation&&(a+="{"+this.explanation+"}");this.annotation&&(a+="("+this.annotation+")");return a};Bridge.Call.prototype.toHTML=function(a){a="";return a=1===this.call.length?a+Bridge.calls[this.call].html:a+(this.call[0]+Bridge.calls[this.call[1]].html)};Bridge||(Bridge={});Bridge.Auction=function(a){this.dealer=(this.deal=a)?a.getDealer():"n";this.vulnerability=a?a.getVulnerability():"-";this.nextToCall=this.dealer;this.calls=[];this.contracts=[]};Bridge.Auction.prototype.getDealer=function(){return this.dealer};Bridge.Auction.prototype.setDealer=function(a){Bridge._checkDirection(a);var b=this.dealer=a;_.each(this.calls,function(a){a.setDirection(b);b=Bridge.getLHO(b)},this);this.nextToCall=b};Bridge.Auction.prototype.getVulnerability=function(){return this.vulnerability};
...
d),this.declarer=this.firstToBid[c][d],this.suit=c,this.level=b}};Bridge.Contract.prototype.toString=function(){var a="";this.level&&(a+=this.level,a+=this.suit,this.redoubled?a+="xx":this.doubled&&(a+="x"),a+=this.declarer);return a};Bridge.Contract.prototype.toHTML=function(){var a="";this.level&&(a+=this.level,a+=Bridge.calls[this.suit].html,this.redoubled?a+=Bridge.calls.r.html:this.doubled&&(a+=Bridge.calls.x.html),a+=" by "+Bridge.directions[this.declarer].html);return a};
